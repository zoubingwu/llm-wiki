...
I have written a paper, [*The Cathedral and the Bazaar*](http://catb.org/~esr/writings/cathedral-bazaar/index.html), which explains a lot about how the Linux and open-source cultures work. I have addressed this topic even more directly in its sequel [*Homesteading the Noosphere*](http://catb.org/~esr/writings/homesteading/).
